...
public class Lab1Utilities {
    ...
    * 
	...
	public static String temperatureConverter(double fahrenheit) {
		...
		return "Fahrenheit (" + fahrenheit + ") is equivalent to (" + celsius + ") in Celsius";
	}
	...
	public static String ageInYearsDetailed(int days) {
		...
		return "Age in days (" +days+ "), age in years is (" +years+ "), months (" +months+ "), with remaining days (" +remainingDays+ ")";
    }
	...
	public static String distanceConverter(double cm) {
		...
		in = cm / 2.54;
		ft = Math.floor(in / 12);
		double remainingIn = in % 12;
		
		String cm1 = String.format("%.2f", cm);
		String ft1 = String.format("%.0f", ft);
		String in1 = String.format("%.2f", remainingIn);
		
		return cm1 + "cm is " + ft1 + "ft and " + in1 + "in";
	...
	public static String fiveYearBalance(double balance, double interest) {
		...
		String r = String.format("%.2f", interest);
		String nB = String.format("%.2f", newBalance);

		return "The balance was " + b + " with interest " + r + ", after five years balance is " + nB;
	}
	...
	public static double computeBMI(int pounds, int feet, int inches) {
		...
		double weight = pounds * 0.453592; // converts lb to kg
		double h1 = feet * 0.3048; // converts ft to m
		double h2 = inches * 0.0254; // converts inch to m
		double height = h1 + h2; // total height in m
